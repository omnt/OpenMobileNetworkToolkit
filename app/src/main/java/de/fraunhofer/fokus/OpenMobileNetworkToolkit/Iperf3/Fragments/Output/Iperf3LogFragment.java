...
public class Iperf3LogFragment extends Fragment {
    ...
    public LinearLayout getInputAsLinearLayoutKeyValue(Iperf3Input input) {
        ...
        addTextView(main, Iperf3Parameter.HOST, input.getParameter().getHost());
        addTextView(main, Iperf3Parameter.PORT, String.valueOf(input.getParameter().getPort()));
        addTextView(main, Iperf3Parameter.PROTOCOL, input.getParameter().getProtocol().toString());
        addTextView(main, Iperf3Parameter.MODE, input.getParameter().getMode().toPrettyPrint());
        addTextView(main, Iperf3Parameter.DIRECTION, input.getParameter().getDirection().toPrettyPrint());
        addTextView(main, Iperf3Parameter.BITRATE, input.getParameter().getBitrate());
        addTextView(main, Iperf3Parameter.TIME, String.valueOf(input.getParameter().getTime()));
        addTextView(main, Iperf3Parameter.IPERF3UUID, input.getParameter().getiPerf3UUID());
        addTextView(main, Iperf3Parameter.STREAMS, String.valueOf(input.getParameter().getNstreams()));
        addTextView(main, Iperf3Parameter.TIMESTAMPS, input.getTimestamp().toString());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (iperf3RunResult.input.getParameter().getDirection()){
            case UP:
            ...
            case DOWN:
                ...
                switch (iperf3RunResult.input.getParameter().getProtocol()){
                    case TCP:
                        break;
                    case UDP:
        ...
        if(iperf3RunResult.input.getParameter().getLogfile() == null){
            iperf3OutputViewer.setText("iPerf3 file path empty!");
            return v;
        }
        file = new File(iperf3RunResult.input.getParameter().getLogfile());
